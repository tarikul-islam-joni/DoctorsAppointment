...
public class DoctorYesterdayAppointmentFragment extends Fragment
{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        CallDBForYesterdayAppointmentList();
    }
    ...
    private void CallDBForYesterdayAppointmentList()
    {
        DoctorAccountDB doctorAccountDB=new DoctorAccountDB(getActivity());
        doctorAccountDB.GetDoctorScheduledAppointmentListFromDoctorAccount(DBConst.SELF,DBConst.AppointmentDate,CurrentDateFormat,DBConst.GetYesterdayDoctorScheduledAppointmentList);
    }
}
