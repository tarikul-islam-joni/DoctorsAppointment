...
public class DoctorTomorrowAppointmentFragment extends Fragment
{
    private View view;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        CallDBForTomorrowAppointmentList();
    }
    ...
    private void CallDBForTomorrowAppointmentList()
    {
        DoctorAccountDB doctorAccountDB=new DoctorAccountDB(getActivity());
        doctorAccountDB.GetDoctorScheduledAppointmentListFromDoctorAccount(DBConst.SELF,DBConst.AppointmentDate,CurrentDateFormat,DBConst.GetTomorrowDoctorScheduledAppointmentList);
    }
