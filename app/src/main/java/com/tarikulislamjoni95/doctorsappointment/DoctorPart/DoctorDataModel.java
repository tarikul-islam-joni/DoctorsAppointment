...
public class DoctorDataModel
{
    ...
    public DoctorDataModel(String name, String hospitalName, String appointmentDate, String appointmentTime) {
        Name = name;
    ...
    public DoctorDataModel(String From, String UID, String name, String hospitalName, String appointmentDate, String appointmentTime, String appointmentFee, String ValidityTime) {
        this.From=From;
        Name = name;
        this.UID = UID;
        HospitalName = hospitalName;
