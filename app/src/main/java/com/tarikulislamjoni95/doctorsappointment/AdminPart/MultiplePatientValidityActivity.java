...
public class MultiplePatientValidityActivity extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visit_multiple_patient);
        ...
        DatabaseReference ref= FirebaseDatabase.getInstance().getReference().child(DBConst.AccountMultiplicity).child(DBConst.Patient).child(BirthNoTv.getText().toString());
