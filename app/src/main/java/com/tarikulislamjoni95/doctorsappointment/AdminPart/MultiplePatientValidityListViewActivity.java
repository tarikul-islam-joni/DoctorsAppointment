...
public class MultiplePatientValidityListViewActivity extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_multiple_patient);
        listView=findViewById(R.id.list_view);
        arrayList=new ArrayList<String>();
        DatabaseReference MuliplicityRef=FirebaseDatabase.getInstance().getReference().child(DBConst.AccountMultiplicity).child(DBConst.Patient);
