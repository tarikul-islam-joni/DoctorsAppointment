...
public class MultipleIdAdapter extends ArrayAdapter<MultipleIdDataModel> implements View.OnClickListener
{
    ...
    public MultipleIdAdapter(String BirthCertificateNo,ArrayList<MultipleIdDataModel> arrayList, Context context) {
        super(context, R.layout.model_each_id_secure_info,arrayList);
    ...
    private void DeleteBNDataMethod()
    {
        ...
        final DatabaseReference ref=FirebaseDatabase.getInstance().getReference().child(DBConst.AccountMultiplicity).child(DBConst.Patient);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            convertView=inflater.inflate(R.layout.model_each_id_secure_info,parent,false);
